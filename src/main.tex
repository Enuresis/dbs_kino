...
% ─── Detaily studenta ────────────────────────────────────
\newcommand{\StudentName}{Peter Mezei, David}
...
\begin{enumerate}
    ...
    \item \textbf{Oprávnenie zamestnanca:} Zamestnanec môže vykonávať úlohu typu ,,Obsluha bufetu`` len vtedy, ak má v systéme evidovaný platný atribút \texttt{zdravotny\_preukaz}.
